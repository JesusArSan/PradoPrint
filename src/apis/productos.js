 ...
 */
router.get('/productos', validateQuery(QuerySchema), asyncHandler(async (req, res) => {
    const { desde, hasta, ordenación } = req.validatedQuery;
 ...
 */
router.post('/productos', validateBody(CreateProductSchema), asyncHandler(async (req, res) => {
 ...
 */
router.put('/producto/:id', validateBody(UpdateProductSchema), asyncHandler(async (req, res) => {
    const id = Number(req.params.id);
 ...
 * Elimina un producto
 */
router.delete('/producto/:id', asyncHandler(async (req, res) => {
    const id = Number(req.params.id);
